...
$fields = array('token', 'sup_wechat_small', 'sup_wechat_big');
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <input type="hidden" value="<?php echo $default_img_pic_big; ?>"
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <input type="hidden" value="<?php echo $default_img_pic_small; ?>"
