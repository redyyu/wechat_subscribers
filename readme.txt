...
4. 回到插件的微信(weixin/Wechat)管理界面，在这里可以添加消息模版，这些消息模版会根据条件自动回复给向你的微信公众号发消息的订阅者。
...
7. 编辑图文消息的时候，必要选择一张图片，第一组图文内容的图片尺寸是360x200，这里的消息简述则可以选填。
8. 上传图片的时候将使用Wordprss原生的图片上传工具。传完以后选一个即可。
